...
public extension UserPreferences {
    ...
    func exportSettings() -> SettingsBundle {
        ...
        bundle.dockMiddleClickEnabled = dockMiddleClickEnabled
        bundle.smoothScrollEnabled = smoothScrollEnabled
        bundle.scrollStepPx = scrollStepPx
        bundle.scrollSmoothingSec = scrollSmoothingSec
    ...
    func importSettings(_ bundle: SettingsBundle) {
        ...
        if let value = bundle.dockMiddleClickEnabled { dockMiddleClickEnabled = value }
        if let value = bundle.smoothScrollEnabled { smoothScrollEnabled = value }
        if let value = bundle.scrollStepPx { scrollStepPx = value }
        if let value = bundle.scrollSmoothingSec { scrollSmoothingSec = value }
